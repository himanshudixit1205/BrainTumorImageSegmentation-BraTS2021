...
# ---------------- CALLBACKS ----------------
os.makedirs("../models/focal_tversky_brats", exist_ok=True)

callbacks = [
    keras.callbacks.ModelCheckpoint(
        "../models/focal_tversky_brats/best_focal_brats.keras",
...
# ---------------- SAVE ----------------
model.save("../models/focal_tversky_brats/final_focal_brats.keras")