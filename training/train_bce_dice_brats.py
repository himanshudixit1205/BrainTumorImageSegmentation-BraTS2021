...
# ---------------- CALLBACKS ----------------
os.makedirs("../models/bce_dice_brats", exist_ok=True)

callbacks = [
    keras.callbacks.ModelCheckpoint(
        "../models/bce_dice_brats/best_bce_dice_brats.keras",
...
# ---------------- SAVE ----------------
model.save("../models/bce_dice_brats/final_bce_dice_brats.keras")