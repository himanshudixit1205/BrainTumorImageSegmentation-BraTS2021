...
# Only non‑zero tumors to avoid zeros
...
# ---- Patient‑level stratified metrics ----
patient_volumes = []
...
results_df.to_csv("../results/metrics/bce_stratified_metrics.csv", index=False)
print("\n Saved: bce_stratified_metrics.csv")